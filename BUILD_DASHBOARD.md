...
A single `<h1 class="dash-title">Ibrahim's dashboard</h1>` at the very top of the body. Styled as:
...
- The page opens with a gradient `Ibrahim's dashboard` headline at the top.
